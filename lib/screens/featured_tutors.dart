...
class FeaturedTutors extends StatefulWidget {
  const FeaturedTutors({super.key});

  @override
  State<FeaturedTutors> createState() => _FeaturedTutorsState();
}

class _FeaturedTutorsState extends State<FeaturedTutors> {
      ...
      return jsonList
          .map((tutorData) {
            try {
              ...
              String tutoringHours = tutorData['tutoringHours'] ?? 'Unknown';
              String recommendation = tutorData['recommendation'] ?? 'Unknown';
              String rate = tutorData['rate'] ?? 'Unknown';
              String availability = tutorData['availability'] ?? 'Unknown';
                      ...
                      return Column(
                        children: [
                          _availableTutorsWidget(
                            ...
                            tutorData["rating"],
                            tutorData["image"],
                            tutorData["tutoringHours"],
                            tutorData["recommendation"],
                            tutorData["rate"],
  ...
  Widget _availableTutorsWidget(
      String? name,
      String? university,
      String? description2,
      String? rating,
      String? image,
      String? tutoringHours,
